...
function ReviewForm({ onSubmitted }) {
  ...
  const submit = async () => {
    if (!form.name || !form.stars || !form.comment) { setError('Please fill in your name, rating, and comment.'); return; }
  ...
  return (
    <div style={{ background: '#fff', border: '1px solid #e0d6c8', borderRadius: '12px', padding: '22px 24px', marginBottom: '20px' }}>
      ...
      <select style={{ ...inp, cursor: 'pointer' }} value={form.course} onChange={e => setForm(f => ({ ...f, course: e.target.value }))}>
        <option>Calculus I</option>
        <option>Pre-Calculus</option>
        <option>Linear Algebra I</option>
      </select>
          ...
          <div style={{ padding: '44px 40px 36px', background: 'linear-gradient(135deg, var(--bg) 0%, var(--bg2) 100%)', borderBottom: '1px solid var(--border)' }}>
            ...
            <div style={{ display: 'flex', gap: '40px', marginTop: '28px', flexWrap: 'wrap' }}>
              ...
              <div>
                ...
                <div style={{ fontSize: '.95rem', color: 'var(--teal)', marginTop: '4px' }}>Ch 5 &amp; 6 Live ✦</div>
              </div>
            </div>
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 300px', gap: '0', alignItems: 'start' }}>
            ...
            <div style={{ padding: '28px 20px 60px', background: paper }}>
              ...
              <div style={{ marginBottom: '24px' }}>
                ...
                {/* Ch5 Quiz */}
                <div style={{ background: '#fff', border: '1px solid #e0d6c8', borderRadius: '10px', padding: '16px 18px', marginBottom: '10px' }}>
                  <div style={{ fontFamily: fm, fontSize: '.6rem', color: teal, letterSpacing: '.1em', textTransform: 'uppercase', marginBottom: '4px' }}>Chapter 5</div>
                  <div style={{ fontFamily: fh, fontSize: '.98rem', color: ink, marginBottom: '4px', fontWeight: 700 }}>Integration Quiz</div>
                  <div style={{ fontFamily: fm, fontSize: '.62rem', color: '#7f8c8d', marginBottom: '10px', lineHeight: 1.5 }}>
                    §5.1 · §5.2 · §5.3<br/>Indefinite · Substitution · Definite Integrals & FTC
                  </div>
                  <Link href="/courses/calc1/ch5-quiz" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', fontFamily: fm, fontSize: '.7rem', letterSpacing: '.08em', textTransform: 'uppercase', background: teal, color: '#fff', borderRadius: '7px', padding: '8px', textDecoration: 'none' }}>⚡ Take Quiz</Link>
                </div>

                {/* Ch6 + A3 Quiz */}
                <div style={{ background: '#fff', border: '1px solid #e0d6c8', borderRadius: '10px', padding: '16px 18px' }}>
                  <div style={{ fontFamily: fm, fontSize: '.6rem', color: '#2980b9', letterSpacing: '.1em', textTransform: 'uppercase', marginBottom: '4px' }}>Chapters 6 + Appendix</div>
                  <div style={{ fontFamily: fh, fontSize: '.98rem', color: ink, marginBottom: '4px', fontWeight: 700 }}>Advanced Integration & Limits</div>
                  <div style={{ fontFamily: fm, fontSize: '.62rem', color: '#7f8c8d', marginBottom: '10px', lineHeight: 1.5 }}>
                    §5.4 · §5.5 · §6.1 · §A.3<br/>Area · Business · IBP · L'Hôpital's Rule
                  </div>
                  <Link href="/courses/calc1/ch6-quiz" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', fontFamily: fm, fontSize: '.7rem', letterSpacing: '.08em', textTransform: 'uppercase', background: '#2980b9', color: '#fff', borderRadius: '7px', padding: '8px', textDecoration: 'none' }}>⚡ Practice Quiz</Link>
                </div>
              </div>
